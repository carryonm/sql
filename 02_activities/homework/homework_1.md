...
**Homework submission**:
- Below is a partial logical model diagram of the tables named `product` and `customer_purchases`.
	-  ![Homework1_Logical_Model.jpg](./images/Homework1_Logical_Model.jpg)
